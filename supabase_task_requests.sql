-- Create peer-to-peer coverage request table
...
-- Leads and SubLeads can insert requests
...
-- Everyone can view task requests
...
-- The targeted user can accept/reject, and the original requester can cancel
